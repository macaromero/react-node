...
// Material UI
import { IconButton, Menu, MenuItem, Divider, Backdrop, Snackbar, Alert, ListItemIcon, Avatar } from '@mui/material';
...
const UserWidget = () => {
    ...
    // Llamada a context
    const {logOut, loggedIn, user, getUserById, initialAvatar} = useContext(LogInContext);
